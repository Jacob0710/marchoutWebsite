...
-- Formal Phase 4 baseline recovered byte-for-byte at the statement level from
-- phase-4-supabase-public-frontend-complete. Later migrations deliberately
-- replace its legacy authenticated policies and make its legacy buckets private.
-- This migration contains schema/configuration only; Phase 4 demo seed rows are
